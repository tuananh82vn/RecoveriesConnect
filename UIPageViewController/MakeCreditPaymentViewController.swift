...
class MakeCreditPaymentViewController: UIViewController , TKDataFormDelegate , UITextViewDelegate {
    ...
    func InitCreditCardPayment(){
        ...
        dataSource2["BSB"].hintText = "BSB"
        dataSource2["BSB"].editorClass = BSBEditor.self
        dataSource2["BSB"].displayName = "BSB"
        ...
        if (propery.name == "PaymentMethod") {
            ...
            if(value == 0){
                ...
                if(value == 1){
                    ...
                    dataSource2["BSB"].hidden = false
                    dataSource2["AccountNumber"].hidden = false
                    
                    dataSource2["AccountName"].index = 2
                    dataSource2["BSB"].index = 3
                    dataSource2["AccountNumber"].index = 4
                ...
                if (propery.name == "ExpiryYear") {
                    ...
                    if (propery.name == "AccountName") {
                        ...
                        if (propery.name == "BSB") {
                            ...
                            if (value.length <= 0)
                            {
                                dataSource2["BSB"].errorMessage = "Please enter BSB"
                                ...
                                {
                                    dataSource2["BSB"].errorMessage = "The BSB number is not valid"
                                    self.validate8 = false
                                    return self.validate8
                            }
...
//                            }
    ...
    @IBAction func btContinue_Clicked(_ sender: AnyObject) {
        ...
        {
            self.isFormValidate = self.validate1 && self.validate7 && self.validate8  && self.validate10
        }
        ...
        else
        {
            ...
            bankObject.BSB              = self.dataSource2["BSB"].valueCandidate as! String
