        ...
        WebApiService.GetPaymentInfo(){ objectReturn in
            ...
            self.view.hideLoading();
                ...
                if let temp1 = objectReturn
                {
                    ...
                    self.dataSource["BSB"].editorClass = BSBEditor.self
                    self.dataSource["BSB"].index = 1
                    self.dataSource["BSB"].displayName = "BSB"
    ...
    func dataForm(_ dataForm: TKDataForm, validate propery: TKEntityProperty, editor: TKDataFormEditor) -> Bool {
        ...
        if (propery.name == "AccountName") {
            ...
            if (propery.name == "BSB") {
                ...
                if (value.length <= 0)
                {
                    dataSource["BSB"].errorMessage = "Please enter BSB"
                    ...
                    {
                        dataSource["BSB"].errorMessage = "The BSB number is not valid"
                        self.validate3 = false
                        return self.validate3
                }
...
//                }
    ...
    @IBAction func btContinue_Clicked(_ sender: AnyObject) {
            ...
            paymentInfo.bank.BSB                = (self.dataSource["BSB"].valueCandidate as AnyObject).description
